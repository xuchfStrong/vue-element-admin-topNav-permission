<template>
  <div class="app-container">
    <el-row>
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px">
        <el-form :inline="true">
          ...
          <el-input v-model="roleeName" placeholder="请输入角色名称" style="width: 200px;padding-left: 5px;padding-right: 20px" class="filter-item" @keyup.enter.native="handleFilter"/>
          <el-form-item>
    ...
    <el-dialog :visible.sync="dialogVisible" :title="dialogType==='edit'?'修改角色':'添加角色'" width="60%" size="small">
...
import { asyncRouterMap } from '@/router/routeStr.js' // 从文件获取所有动态路由，也可以从后台服务器获取
...
export default {
  ...
  methods: {
    ...
    // },
    getRoutes() {
      this.serviceRoutes = asyncRouterMap
      const routes = this.generateRoutes(asyncRouterMap)
      this.routes = this.i18n(routes)
    },
    async getRoles() {
